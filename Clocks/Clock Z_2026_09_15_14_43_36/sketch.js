...
function draw() {
  ...
  trailAngle = draggingHand === 'trail' ? getMouseAngle() : paused ? pausedTrailAngle : (-(minuteAngle-secondAngle + 360/2) + trailOffset);

  noFill();
  strokeWeight(20);
  arc(0, 0, minutesRadius*1.25, minutesRadius*1.25, (minuteAngle - 90), (secondAngle - 90))
  stroke("#000");
