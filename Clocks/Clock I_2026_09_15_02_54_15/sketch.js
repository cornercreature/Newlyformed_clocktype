...
function draw() {
  ...
  noFill();
  strokeWeight(16);
  arc(0, 0, (minutesRadius*0.6), (minutesRadius*0.6), (minuteAngle - 90), (secondAngle - 90))
  stroke("#000");
  
  // ark2
  noFill();
  strokeWeight(16);
  arc(0, 0, (clockDiameter - 50), (clockDiameter - 50), (minuteAngle -110), (minuteAngle - 70))
  stroke("#000");

    // ark3
  noFill();
  strokeWeight(16);
  arc(0, 0, (clockDiameter - 50), (clockDiameter - 50), (secondAngle -110), (secondAngle - 70))
  stroke("#000");
  ...
  rotate(secondAngle);
  strokeWeight(10);
  line(0, - (minutesRadius * 0.3), 0, -(secondsRadius));
  pop();
  ...
  strokeWeight(4);
  rotate(minuteAngle);
  line(0, - (minutesRadius * 0.3), 0, - (minutesRadius * 1.2));
  pop();
